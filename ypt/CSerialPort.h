...
{
public:
	bool		getRecvBuff(SerialData &data);			//读取n个字节到缓存
	bool		setSendBuff(const SerialData &data);

private:
	SerialData	sRecv;		//接收数据缓存
	SerialData	sSend;		//发送数据缓存
...
private:
	...
	static const UINT SLEEP_TIME_INTERVAL = 5;
